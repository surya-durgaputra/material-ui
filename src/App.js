    ...
    return (
      <BrowserRouter>
        ...
        <div>
          <NavBar
            onClick={() => {
              // this.sideNav.handleLeftOpen()
              console.log(Object.getOwnPropertyNames(this.sideNav))
              console.log(Object.keys(this.sideNav))
            }}
            title="Title"
          />
          <SideNav open={false} ref={sideNav => (this.sideNav = sideNav)} />
          <Switch>
